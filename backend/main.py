...
CORPUS = {
    ...
    "special_scenarios": {
        ...
        "fasting": {
            "morning": [
                "早安！断食期间身体正在自我修复呢～小浣熊陪你一起加油！💪",
                "你选择了给身体放假，它会感谢你的！感觉怎么样？",
                "断食也是一种自律呀～但别忘了喝水哦！💧",
            ],
            "afternoon": [
                "下午了，感觉还好吗？身体正在燃烧脂肪呢！🔥",
                "小浣熊相信你能行的！晚点可以准备一顿健康的晚餐～",
                "今天的你很有决心呢！小浣熊给你点赞！👍",
            ],
            "evening": [
                "快到晚餐时间了！准备break fast了吗？今天想吃点什么呢？🍽️",
                "断食一天很棒！现在可以好好享用一顿健康的晚餐啦～",
                "你今天真的好厉害！小浣熊为你骄傲！🌟",
            ],
        },
        ...
        # 深夜宵夜
        "midnight_snack": {
            "time_check": "这么晚还没睡呀...小浣熊都困了，你呢？🌙",
            "snack_messages": [
                "深夜觅食中...小浣熊也懂这种快乐！🍜",
                "深夜的美食最有味道了，对吧？不要太有罪恶感哦～",
                "这块布丁里藏着深夜的流星，它的甜度正好能修补你今天的疲惫！🌠",
                "夜猫子一枚！不过...吃了这顿，明天早餐要轻一点哦～",
                "小浣熊陪你一起熬夜！记得喝点水，身体要照顾好呀！💧",
            ],
            "comfort": [
                "没关系呀～深夜的快乐最重要，明天的卡路里明天再算！😴",
                "吃饱了好好睡，小浣熊在这里守着你～晚安！🌙",
            ],
        },
        ...
        "water_goal_reached": {
            "early": [
                "哇！早上就把水喝够了？你一定是早起达人！☀️",
                "水分满分！今天的你已经赢在起跑线了！💧",
            ],
            "midday": [
                "太棒了！今天的喝水任务完成啦！你真的好会照顾自己～💪",
                "小浣熊感觉到了！你喝下的不仅是水，是生命力的清泉！✨",
                "看，小浣熊的毛发都透亮了！这就是水分的力量！🌟",
            ],
            "evening": [
                "今日水分目标达成！你真的很注重健康呢～小浣熊给你颁发成就徽章！🏅",
                "水润的你，看起来精神满满！继续保持呀！💧✨",
            ],
            "encouragement": [
                "还差一点就达标了！小浣熊相信你可以的！💪",
        ...
        # 连续记录
        "streak": {
            "3_days": ["连续3天了！你已经开始形成习惯啦～小浣熊为你骄傲！🎉"],
            "7_days": ["一周坚持！你真的太厉害了！小浣熊好感动！😭💕"],
            "30_days": ["一个月！！你是真正的达人！小浣熊给你跪了！👑🏆"],
            "100_days": ["100天！！这是传说级的坚持！小浣熊永远追随你！🌟✨"],
        },
        
        # 暴饮暴食后
        "binge": {
            "reassure": [
                "能量满溢了呢！别担心，我们只是在为明天的冒险提前'充电'～抱抱！🤗",
                "小浣熊完全理解～有时候就是想放纵一下嘛！这也是生活的一部分呀～",
                "你知道吗？偶尔的放纵其实是身体在告诉你它需要能量呢！💕",
                "吃完就吃完啦～不要纠结，向前看！小浣熊永远在这里陪你！✨",
            ],
            "comfort": [
                "没关系的～这一顿不代表什么，你已经在好好照顾自己了！💖",
                "小浣熊不评判，只陪伴～吃饱了就开心吧！🌈",
            ],
        },
        ...
        # 健身后
        "post_workout": {
            "morning": ["早起锻炼！你一定是健身狂热者！小浣熊感觉到了肌肉在生长！💪"],
            "general": [
                "运动后的补给最重要！蛋白质+碳水是肌肉恢复的黄金搭档～🥚🍞",
                "你正在变强呢！小浣熊都能看到你的肌肉线条了...大概？😂",
                "练完了？那就来一顿犒劳自己的健康餐吧！奖励一下自己！🎉",
                "汗水不会骗人的！今天的你比昨天更强了！💪✨",
            ],
        },
        ...
        "feeling_down": {
            "empathy": [
                "小浣熊感觉到了...今天有点不开心对吗？🤗",
                "没关系的，难过也是一种情绪～小浣熊陪你静静待一会儿...",
                "你知道吗？有时候哭出来会好受一点，小浣熊这里有纸巾...虚拟的 🧻",
                "不管怎样，小浣熊都在这里。你不是一个人哦～💕",
            ],
            "comfort": [
                "抱抱～不管发生什么，你都是独一无二的存在！✨",
                "吃点甜的会让心情变好哦～这是有科学依据的！🍰",
                "小浣熊永远在这里等你。不管世界怎么变，我不会变～🌟",
            ],
        },
        ...
        "high_protein": {
            "muscle": [
                "噢！这些蛋白质简直是为你冲浪时的核心力量定制的！我感觉到肌肉在唱歌！🏄",
                "健身达人的选择！小浣熊都能看到二头肌了...呃，也许是我的错觉？💪",
                "蛋白质满满！你在为更大的力量做准备呢！继续加油！🔥",
            ],
            "balance": [
                "蛋白质很足！但别忘了吃点蔬菜哦～营养均衡才是王道！🥗",
                "健身餐get！小浣熊建议再来点碳水，这样训练才有劲！🍠",
            ],
        },
        ...
        "vegetarian": {
            "praise": [
                "素食主义者！小浣熊敬佩你的选择！地球妈妈会感谢你的！🌍💚",
                "植物蛋白也很强大呢！你看起来越来越健康了！🌿",
                "小浣熊也想试试吃素...但我太喜欢虫子了（小声）🐛",
            ],
            "tips": [
                "记得补充.complete蛋白质哦～豆腐+米饭就是完美组合！🍚",
                "素食要注意B12摄入，可以吃点营养酵母～小浣熊的小贴士！💡",
            ],
        },
        ...
        "celebration": {
            "birthday": [
                "🎂🎉 HAPPY BIRTHDAY!!! 🎉🎂",
                "今天是你的特别日子！蛋糕是必须的！热量什么的先不要管，今天只管开心！🥳💖",
            ],
            "holiday": [
                "节日大餐！这是犒劳自己一整年辛苦的时刻呀～尽情享受吧，小浣熊批准！🎄✨",
                "节日的味道！小浣熊和你一起庆祝！🎉🎊",
            ],
            "achievement": [
                "你完成了一个里程碑！小浣熊为你鼓掌！👏👏👏",
