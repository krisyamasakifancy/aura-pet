...
/// P19: 成就详情
class P19AchievementDetailScreen extends StatelessWidget {
  const P19AchievementDetailScreen({super.key});
  ...
  Widget _buildPet() {
    final isSleeping = 'celebrating' == 'sleeping';
    final isDiving = 'celebrating' == 'diving';
    final isCelebrating = 'celebrating' == 'celebrating';
