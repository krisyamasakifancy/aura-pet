...
/// P13: 禁食计时
class P13FastingScreen extends StatelessWidget {
  ...
  Widget _buildPet() {
    final isSleeping = 'sleeping' == 'sleeping';
    final isDiving = 'sleeping' == 'diving';
    final isCelebrating = 'sleeping' == 'celebrating';
